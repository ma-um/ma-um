package com.spuit.maum.musicserver.web.config;
...
public class SwaggerConfig {
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title("Maum music-server API")
        .description("Maum music-server API Reference for Developers")
