package com.spuit.maum.authserver.web.config;
...
public class SwaggerConfig {
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title("Maum auth-server API")
        .description("Maum auth-server API Reference for Developers")
